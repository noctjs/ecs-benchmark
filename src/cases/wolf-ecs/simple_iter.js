...
export default function (n) {
  ...
  function sysAB() {
    const lA = A;
    const lB = B;
    for (let i = 0, l = qAB.a.length; i < l; i++) {
      const arch = qAB.a[i].e;
  ...
  function sysCD() {
    const lC = C;
    const lD = D;
    for (let i = 0, l = qCD.a.length; i < l; i++) {
      const arch = qCD.a[i].e;
      for (let j = 0, l = arch.length; j < l; j++) {
  ...
  function sysCE() {
    const lC = C;
    const lE = E;
    for (let i = 0, l = qCE.a.length; i < l; i++) {
      const arch = qCE.a[i].e;
      for (let j = 0, l = arch.length; j < l; j++) {
        const temp = lC[arch[j]];
        lC[arch[j]] = lE[arch[j]];
        lE[arch[j]] = temp;
